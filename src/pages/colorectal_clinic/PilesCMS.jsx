...
import EditablePilesHero from '../../components/colorectal_clinic/piles/EditablePilesHero';
import EditablePilesMain from '../../components/colorectal_clinic/piles/EditablePilesMain';
...
const PilesCMS = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-blue-50 to-white min-h-screen">
      ...
      >
        <EditablePilesHero
          data={localData.hero || { backgroundImage: '', title: 'Piles or Haemorrhoids', description: '', buttonText: 'Book a Consultation' }}
      ...
      <EditableSection
        ...
        saving={saving.main}
        sectionName="Piles Main Content"
      >
        <EditablePilesMain
