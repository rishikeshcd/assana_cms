...
/**
 * EditableAnalFissureMain - CMS wrapper for AnalFissureMain component
 * Same as PilesMain with bullet points
 */
const EditableAnalFissureMain = ({ data, onDataChange }) => {
  const safeData = data || {
    sections: [],
    conclusion: {
      title: 'Conclusion',
...
export default EditableAnalFissureMain;
