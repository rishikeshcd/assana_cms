...
/**
 * EditableAnalWoundCareContent - CMS wrapper for AnalWoundCareContent component
 * 2 left cards, 3 right cards layout
 */
const EditableAnalWoundCareContent = ({ data, onDataChange }) => {
  const safeData = data || {
  ...
  return (
    <div className="bg-[#0000000A] py-12 md:py-16 lg:py-20">
      <div className="max-w-[1600px] mx-auto px-6 md:px-8 lg:px-16">
        ...
        {/* Three Column Layout - 2 left, center image, 3 right */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col gap-y-6">
            ...
            {renderEditableTextBox('rightMiddleSection', 'right-middle')}
...
export default EditableAnalWoundCareContent;
