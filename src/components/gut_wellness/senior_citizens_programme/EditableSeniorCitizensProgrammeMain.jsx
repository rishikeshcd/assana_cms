...
/**
 * EditableSeniorCitizensProgrammeMain - CMS wrapper for SeniorCitizensProgrammeMain component
 */
const EditableSeniorCitizensProgrammeMain = ({ data, onDataChange, onSave }) => {
  const safeData = data || {
    sections: [],
    conclusion: {
      text: '',
...
export default EditableSeniorCitizensProgrammeMain;
