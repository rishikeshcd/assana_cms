...
/**
 * EditableMenopauseProgramHero - CMS wrapper for MenopauseProgramHero component
 */
const EditableMenopauseProgramHero = ({ data, onDataChange }) => {
  const safeData = data || {
    backgroundImage: '',
...
export default EditableMenopauseProgramHero;
