...
/**
 * EditableNewMomProgramMain - CMS wrapper for NewMomProgramMain component
 * Dynamic left and right cards with add/remove functionality
 * Supports bullet points in card descriptions
 */
const EditableNewMomProgramMain = ({ data, onDataChange }) => {
  const safeData = data || {
...
export default EditableNewMomProgramMain;
